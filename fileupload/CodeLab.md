author: DFINITY
summary: Fileupload in Motoko 
id: fileupload
categories: codelab,markdown
environments: Web
status: Published
feedback link: https://github.com/dfinity/examples
...
The fileupload is done in chunks, to support uploading larger files than 2MB, which is the ingress limit. Uploaded files are stored in an asset canister, which can serve assets like image files. See the full project source code [here](https://github.com/dfinity/examples/tree/master/motoko/fileupload).
...
DFX will create a new directory called fileupload, and in this directory you will find all the files, both frontend, backend, configurations etc. for the default project. The default project can be deployed without any changes as it is.

The default files for both frontend and backend will be used as a starting point, and modified to accomplish the desired functionality.
